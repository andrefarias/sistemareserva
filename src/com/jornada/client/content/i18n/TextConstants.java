...
public interface TextConstants extends Messages {
    ...
    String menuTokenFerramentaCoordenadorReserva();
	...
	String menuTokenFerramentaSalaoAvaliacao();
	String menuTokenFerramentaSalaoNota();
    String menuTokenFerramentaSalaoConteudoProgramatico();
	String menuTokenFerramentaSalaoTopico();
	String menuTokenFerramentaSalaoComunicado();	
	String menuTokenFerramentaSalaoOcorrencia();
	String menuTokenFerramentaSalaoHierarquia();
	String menuTokenFerramentaSalaoDiario();	
	String menuTokenFerramentaSalaoPresenca();
    String menuTokenFerramentaSalaoRelatorio();
   ...
   /******AmbienteDoCoordenador End******/
    ...
    /******AmbienteDoSalao Begin******/
    String SalaoAmbiente();
    String SalaoAmbienteCompText1();
    String SalaoAmbienteCompText2();
    String SalaoAmbienteCompText3();
    String SalaoAmbienteCompText4();
    String SalaoAmbienteCompText5();
    String SalaoAmbienteCompText6();    
    
    String SalaoAmbienteAvaliacao();
    String SalaoAmbienteAvaliacaoCompText1();
    String SalaoAmbienteAvaliacaoCompText2();
    
    String SalaoAmbienteNotas();
    String SalaoAmbienteNotasCompText1();
    String SalaoAmbienteNotasCompText2();
    
    String SalaoAmbienteOcorrencia();
    String SalaoAmbienteOcorrenciaCompText1();
    String SalaoAmbienteOcorrenciaCompText2();
    
    String SalaoAmbienteConteudoProgramatico();
    
    String SalaoAmbienteComunicado();
    String SalaoAmbienteComunicadoCompText1();
    String SalaoAmbienteComunicadoCompText2();    
    
    String SalaoAmbienteTopico();
    String SalaoAmbienteTopicoCompText1();
    String SalaoAmbienteTopicoCompText2();
    String SalaoAmbienteTopicoCompText3();
    
    String SalaoAmbienteHierarquia();    
    String SalaoAmbienteHierarquiaCompText1();
    String SalaoAmbienteHierarquiaCompText2();
   ...
   /*******Pais End*******/
    ...
    String relatorioUsuarioSalaoDisciplina();
    /*******Relatorio END*******/
