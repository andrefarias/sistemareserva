...
import com.jornada.client.ambiente.MainViewAmbienteSalao;
...
//	MainViewComunicadosEscola comunicadosEscola;
	MainViewAmbienteSalao ambienteSalao;
...
//	MainViewNotasEscolares notasEscolares = new MainViewNotasEscolares();
	...
	private MainBody(MainView mainView) {
		...
		ambienteSalao = MainViewAmbienteSalao.getInstance(mainView);
...
//		grid.setSize("100%", "100%");
		...
		grid.setWidget(0, 1, ambienteSalao);
