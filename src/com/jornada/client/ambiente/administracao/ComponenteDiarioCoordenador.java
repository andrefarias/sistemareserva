...
public class ComponenteDiarioCoordenador extends Composite{

	static TextConstants txtConstants = GWT.create(TextConstants.class);
	
    private static ComponenteDiarioCoordenador uniqueInstance;
	
	public static ComponenteDiarioCoordenador getInstance(){
		if(uniqueInstance==null){
			uniqueInstance = new ComponenteDiarioCoordenador();
		}
		return uniqueInstance;
	}	
	
	private ComponenteDiarioCoordenador(){
