...
public class ComponenteAmbienteEscritorio extends Composite {
    ...
    private static ComponenteAmbienteEscritorio uniqueInstance;
	
	public static ComponenteAmbienteEscritorio getInstance(MainView mainView){
		if(uniqueInstance==null){
			uniqueInstance = new ComponenteAmbienteEscritorio(mainView);
		}
		return uniqueInstance;
	}
	
	private ComponenteAmbienteEscritorio(MainView mainView) {	
