    ...
    public static void drawChart(FlexTable tableChart, ArrayList<String> arrayList, int intMostrarItens) {
        ...
        chartLoader.loadApi(new Runnable() {
            ...
            public void run() {
                ...
                tabelaDados.setWidget(0, 0, new MpLabelCenterBold("Grupo Observações"));
                ...
                //Preparing Atendentes
                  MpPieChartOptions optionsAtendentes = new MpPieChartOptions("Observações");
                  list = arrayList;           
