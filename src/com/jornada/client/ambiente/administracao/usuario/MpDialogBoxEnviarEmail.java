...
public class MpDialogBoxEnviarEmail extends DecoratedPopupPanel implements ClickListener {
...
//	private Usuario usuario;
	...
	private static MpDialogBoxEnviarEmail uniqueInstance;
	
	Grid grid;
	Anchor anchor;
	
	public static MpDialogBoxEnviarEmail getInstance(ArrayList<Usuario> listUsuarios){
		
		if(uniqueInstance==null){
			uniqueInstance = new MpDialogBoxEnviarEmail(listUsuarios);
	...
	private MpDialogBoxEnviarEmail(ArrayList<Usuario> listUsuarios) {
