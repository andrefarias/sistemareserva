...
public class MpListBoxAtendentes extends MpListBox {	
	
	private AsyncCallback<ArrayList<String>> callBackPopulateComboBox;
	
	public MpListBoxAtendentes(){
...
//					addItem(Avaliacao.TODAS,Avaliacao.TODAS);
					...
					try {
						DomEvent.fireNativeEvent(Document.get().createChangeEvent(),MpListBoxAtendentes.this);
					} catch (Exception ex) {
...
//				listBoxCurso.addItem(new Label("Erro popular curso.").getText());
	...
	public void populateComboBox() {
		startLoadingListBox();
		GWTServiceUsuario.Util.getInstance().getAtendentes(callBackPopulateComboBox);
	}
