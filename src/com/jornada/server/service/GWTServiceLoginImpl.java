...
//		}
        ...
        System.out.println("Usuario user = UsuarioServer.getUsuarioPeloLogin(login); Starting");
		Usuario user = UsuarioServer.getUsuarioPeloLogin(login);
		System.out.println("Usuario user = UsuarioServer.getUsuarioPeloLogin(login); DONE");
		
		System.out.println("boolean valid = BCrypt.checkpw(password, user.getSenha()); Starting");
		boolean valid = BCrypt.checkpw(password, user.getSenha());
		System.out.println("boolean valid = BCrypt.checkpw(password, user.getSenha()); DONE");
